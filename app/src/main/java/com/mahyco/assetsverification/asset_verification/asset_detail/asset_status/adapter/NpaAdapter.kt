...
class NpaAdapter (val menuList: ArrayList<NotInUseReasonModel>, val onCLick: onNpaCLick) :
    RecyclerView.Adapter<NpaAdapter.ViewHolder>() {
...
interface onNpaCLick {
    fun onNpaSelect(position: Int)
}